// <copyright file="TokenPriceData.cs" company="IOTA Content Creator DAO LLC">
...
public class TokenPriceData
{
    ...
    public decimal? MarketCap
    {
        get
        {
            if ((_marketCap == decimal.Zero || _marketCap == null) && TokenInfo.Symbol.Equals("SMR", StringComparison.InvariantCultureIgnoreCase) && CurrentPrice.HasValue)
            {
                return CurrentPrice.Value * 1813620509;
            }
